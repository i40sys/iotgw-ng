...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 decision-028 §4 records a rotation trigger and an overlap window, and its status flips to DECIDED
- [ ] #2 The overlap window is shown to exceed the host-certificate TTL with margin
